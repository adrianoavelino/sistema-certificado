class CertificadosController < ApplicationController
  ...
  def certificado_params
    params.require(:certificado).permit(:ano, :data_emissao, :participant_id, :event_id, :titulo, :periodo_inicial, :periodo_final, :carga_horaria, :certification_type_id, :dados_adicionais, :emission_sector_id, :anexo, :observacoes)
  end
